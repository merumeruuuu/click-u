...
if (count($errors) == 0) {
  ...
  echo "<script>alert('Profile successfully updated!');window.location.href='kitchen_staff_profile.php';</script>";
}
}
 ?>
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="kitchen_staff_profile.php"method="post">
                                  <?php
                                      $_SESSION['user']['user_id'];
          														 $id = $_SESSION['user']['user_id'];
          														 $result = "SELECT
                                  ...
                                  <center><input type="submit" class="btn btn-success btn-fill pull-right"name="update_staff_profile"value="Update Profile"></center>
