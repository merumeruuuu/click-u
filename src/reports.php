...
<script type="text/javascript">
  function session_report(value) {
          $.ajax({
              type: "POST",
              url: 'ajaxrequest/sessionReports.php',
    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
              <div class="card ">
                        <div class="header">
                        <h4 class="title">Borrowing Reports </h4>
                        <p class="category"> </p>
                          </div>
                    <div class="content">
                      <div class="row">
                      <div class="col-md-3">
                        ...
                        <span><select class="form-control" name="reports_ses"id="reports_ses"onchange="session_report(this.value)">
                          <option value="<?php echo $all_report; ?>"<?php if ($_SESSION['default_report'] == 1) {  echo $selected;  } ?>>  All Borrowing Reports</option>
                          ...
                          <div class="col-md-3">
                            <br>
                            <a href="discrepancy_report.php" class="btn btn-fill btn-info">Generate Report</a>
                          </div>
                      </div>
                    </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
              ...
              <a href="reports.php?close_modal" class="close" data-dismiss="modal">&times;</a>
            </div>
...
<?php if ($_SESSION['default_report_date']==3) {
  ?>
...
<?php if ($_SESSION['default_report_date']==1) {
  ?>
  $('#ALL_UTENSILS').DataTable( {
   "pageLength": 50
   } );
