...
if (count($errors) == 0) {
  ...
  echo "<script>alert('Profile successfully updated!');window.location.href='dean_profile.php';</script>";
}
}
 ?>
<div class="content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="dean_profile.php"method="post">
                                  <?php
                                      $_SESSION['user']['user_id'];
          														 $id = $_SESSION['user']['user_id'];
          														 $result = "SELECT
                ...
                <br><br><br>
                    <div class="col-md-4" style="margin-top:1%;">
                        <div class="card card-user">
                            ...
                            <hr>
                            <div class="">
                            <center>  <button type="submit" class="btn btn-success btn-fill"data-toggle="modal" data-target="#myModal1" href="#">Change Password</button></center>
                              <div class="clearfix"></div>
                              <br>
                            </div>
                        </div>
        ...
        <div class="modal fade modal-mini modal-primary" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"data-backdrop="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="">
                              <form method="post" action="dean_profile.php" class="form-login">
